...
- (void)viewDidLoad {
    [super viewDidLoad];
	items = [[NSArray alloc] initWithObjects:@"One",
			 @"Two",
			 @"Three",
			 @"Four",
			 nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString * s = [items objectAtIndex:[indexPath indexAtPosition:1]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	 ...
	 */
	NSString * name = [items objectAtIndex:
					   [indexPath indexAtPosition:1]];
	DetailTableViewController * detail = 
	[[DetailTableViewController alloc] 
	 initWithNibName:@"DetailTableViewController" 
	 bundle:nil];
	[[detail navigationItem] setTitle:name];
